...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        self.add_argument('--gnn_model_path', type=str, default='gnn_branch_model.pt',
                          help='Path to trained GNN branching model.',
                          hierarchy=h + ["gnn_model_path"])
        self.add_argument('--gnn_fallback', type=str, default='babsr',
                          help='Fallback branching method when GNN is unavailable.',
                          hierarchy=h + ["gnn_fallback"])
